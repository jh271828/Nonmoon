---
title: "EE463 Cleaning contamination control"
created: 2026-08-29
updated: 2026-08-29
tags: [learning]
source: "학습 세션 → Issue #72 (수집기: ingest_learning_note.py)"
status: active
kind: mixed
runner: GPT-5.6 Sol
source_issue: 72
...
# EE463 Cleaning contamination control
...
- Organic contamination 제거의 핵심은 산-염기 반응보다는 강한 산화 조건에서 유기물을 분해하는 것.
- RCA clean 전위표는 렉노가 oxidation potential을 사용하므로 일반적인 reduction potential과 부호 방향을 혼동하지 않기.

## 다음 복습 질문

- Particle, organic, metal contamination은 각각 어떻게 제거하는가?
- RCA clean에서 H2O2가 metal을 제거하는 과정을 electron transfer와 ionization까지 연결해 설명하라.
- Clean room, wafer cleaning, human control의 역할 차이는 무엇인가?
