...
3. Interposer가 필요한 이유를 'Substrate가 Die 수준의 높은 배선 밀도를 직접 처리할 수 없기 때문'이라고 완전한 문장으로 설명하는 것
4. TSV와 Micro Bump의 역할 분담
...
4. Die에서 PCB까지의 신호 경로를 각 구성요소의 역할과 함께 설명해 보라.
